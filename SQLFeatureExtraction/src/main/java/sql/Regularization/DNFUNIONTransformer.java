...
/**
 * This module transforms any OR expression it meets in the DNFed formula in the query
 * and turn the query into corresponding UNION representation
 * note it will first automatically apply DNF Normalization module
 * @author tingxie
 *
 */
