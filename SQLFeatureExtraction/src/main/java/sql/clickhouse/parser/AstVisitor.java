...
import sql.clickhouse.parser.ast.AddColumnAlterTableClause;
import sql.clickhouse.parser.ast.AddIndexAlterTableClause;
import sql.clickhouse.parser.ast.AlterTableClause;
import sql.clickhouse.parser.ast.AlterTableQuery;
import sql.clickhouse.parser.ast.ArrayJoinClause;
import sql.clickhouse.parser.ast.AttachAlterTableClause;
import sql.clickhouse.parser.ast.ClearAlterTableClause;
import sql.clickhouse.parser.ast.CodecAlterTableClause;
import sql.clickhouse.parser.ast.CommentAlterTableClause;
import sql.clickhouse.parser.ast.DataClause;
import sql.clickhouse.parser.ast.DeleteAlterTableClause;
import sql.clickhouse.parser.ast.DetachAlterTableClause;
import sql.clickhouse.parser.ast.DropColumnAlterTableClause;
import sql.clickhouse.parser.ast.DropIndexAlterTableClause;
import sql.clickhouse.parser.ast.DropPartitionAlterTableClause;
import sql.clickhouse.parser.ast.FreezePartitionAlterTableClause;
import sql.clickhouse.parser.ast.FromClause;
import sql.clickhouse.parser.ast.GroupByClause;
import sql.clickhouse.parser.ast.HavingClause;
import sql.clickhouse.parser.ast.INode;
import sql.clickhouse.parser.ast.Identifier;
import sql.clickhouse.parser.ast.InsertQuery;
import sql.clickhouse.parser.ast.JoinConstraintClause;
import sql.clickhouse.parser.ast.LimitByClause;
import sql.clickhouse.parser.ast.LimitClause;
import sql.clickhouse.parser.ast.LimitExpr;
import sql.clickhouse.parser.ast.Literal;
import sql.clickhouse.parser.ast.ModifyAlterTableClause;
import sql.clickhouse.parser.ast.MovePartitionToDiskAlterTableClause;
import sql.clickhouse.parser.ast.MovePartitionToTableAlterTableClause;
import sql.clickhouse.parser.ast.MovePartitionToVolumeAlterTableClause;
import sql.clickhouse.parser.ast.NumberLiteral;
import sql.clickhouse.parser.ast.OrderByAlterTableClause;
import sql.clickhouse.parser.ast.OrderByClause;
import sql.clickhouse.parser.ast.PartitionClause;
import sql.clickhouse.parser.ast.PrewhereClause;
import sql.clickhouse.parser.ast.RemoveAlterTableClause;
import sql.clickhouse.parser.ast.RemoveTTLAlterTableClause;
import sql.clickhouse.parser.ast.RenameAlterTableClause;
import sql.clickhouse.parser.ast.ReplaceAlterTableClause;
import sql.clickhouse.parser.ast.SampleClause;
import sql.clickhouse.parser.ast.SelectStatement;
import sql.clickhouse.parser.ast.SelectUnionQuery;
import sql.clickhouse.parser.ast.SettingsClause;
import sql.clickhouse.parser.ast.StringLiteral;
import sql.clickhouse.parser.ast.TTLAlterTableClause;
import sql.clickhouse.parser.ast.TTLClause;
import sql.clickhouse.parser.ast.TableIdentifier;
import sql.clickhouse.parser.ast.UpdateAlterTableClause;
import sql.clickhouse.parser.ast.WhereClause;
import sql.clickhouse.parser.ast.WithClause;
import sql.clickhouse.parser.ast.expr.AliasColumnExpr;
import sql.clickhouse.parser.ast.expr.AssignmentExpr;
import sql.clickhouse.parser.ast.expr.AsteriskColumnExpr;
import sql.clickhouse.parser.ast.expr.CodecArgExpr;
import sql.clickhouse.parser.ast.expr.CodecExpr;
import sql.clickhouse.parser.ast.expr.ColumnExpr;
import sql.clickhouse.parser.ast.expr.FunctionColumnExpr;
import sql.clickhouse.parser.ast.expr.IdentifierColumnExpr;
...
import sql.clickhouse.parser.ast.expr.TableArgExpr;
import sql.clickhouse.parser.ast.expr.TableElementExpr;
import sql.clickhouse.parser.ast.expr.TableExpr;
import sql.clickhouse.parser.ast.expr.TableFunctionExpr;
